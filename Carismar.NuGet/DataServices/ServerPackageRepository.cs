...
namespace Carismar.NuGet.DataServices
{
    ...
    {
        private ConcurrentDictionary<IPackage, DerivedPackageData> _packages;
        ...
        private void RemovePackageFromCache(ConcurrentDictionary<IPackage, DerivedPackageData> packages, IPackage package)
        {
            DerivedPackageData oldData;
            packages.TryRemove(package, out oldData);
        }
        ...
        /// </summary>
        private ConcurrentDictionary<IPackage, DerivedPackageData> PackageCache
        {
            get
            {
                lock (_lockObj)
